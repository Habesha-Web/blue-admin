...
var testsRolesPostID = []struct {
	...
	{
		name:        "post Role - 1",
		description: "post Single Role",
		route:       "/"+group_path+"/role",
...
var testsRolesGet = []struct {
	...
	// First test case
	{
		...
		route:        "/"+group_path+"/role?page=1&size=10",
		expectedCode: 200,
	},
	// First test case
	{
		...
		description:  "get HTTP status 200",
		route:        "/"+group_path+"/role?page=0&size=-5",
		expectedCode: 400,
	},
	// Second test case
	{
		...
		description:  "get HTTP status 404, when Role Does not exist",
		route:        "/"+group_path+"/role?page=1&size=0",
		expectedCode: 400,
	},
}
